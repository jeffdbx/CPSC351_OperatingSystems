...
int main()
{
	cout << "Wait patiently and let me run for a minute or two and I'll start printing records, I promise!\n";
	cout << "Also, I am not deadlocking, I swear! The titan server is just slow as heck when running me remotely.\n";
	cout << "For best results, run me locally :)\n";
	...
	for(;;)
	{
		/* Set the message type to 2 - this must match
		 * the 4th parameter of msgrcv() in the server
		 */
		msg.messageType = 2;
		 ...
		 * @param msg - the message structure where to store the
		 * received message
